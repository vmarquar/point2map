...
def rasterCatalogName2textElement(footprint_layer=r"geo1/GK25_footprint" ,pointGeometry="temp.shp",text_element="Karte"):
    ...
    try:
        ...
        arcpy.AddMessage("Fehler in Funktion rasterCatalogName2textElement (rasterCatalogName2textElement -> point2map-library).")
